export const translations = {
    en: {
        ...
        'nav.family': 'Family',
        'family.title': 'Family',
        'family.info_title': 'Family Management',
        'family.info_description': 'Here you can manage family members and permissions. Send requests to other users to be able to register them for events and pay for them.',
        'family.invite_email': 'User email',
        'family.can_pay': 'Can pay',
        'family.send_invite': 'Send request',
        'family.sent_requests': 'Sent requests',
        'family.received_requests': 'Received requests',
        'family.family_members': 'Family members',
        'family.no_sent_requests': 'No sent requests',
        'family.no_received_requests': 'No received requests',
        'family.no_family_members': 'No family members',
        'family.status_pending': 'Pending',
        'family.status_accepted': 'Accepted',
        'family.status_rejected': 'Rejected',
        'family.status_canceled': 'Canceled',
        'family.accept': 'Accept',
        'family.reject': 'Reject',
        'family.cancel': 'Cancel',
        'family.remove': 'Remove',
        'family.confirm_send': 'Are you sure you want to send a request to this user?',
        'family.confirm_remove': 'Are you sure you want to remove this family member?',
        'family.confirm_accept': 'Are you sure you want to accept this request?',
        'family.confirm_reject': 'Are you sure you want to reject this request?',
        'family.request_sent': 'Request sent',
        'family.request_accepted': 'Request accepted',
        'family.request_rejected': 'Request rejected',
        'family.permission_canceled': 'Permission canceled',
        ...
        'family.error_user_inactive': 'Sorry, we cannot send the request because the user is not activated. Please send the request after the administrator activates the user.',
        'family.error_user_not_found': 'User with this email does not exist.',
        'family.error_request_to_self': 'You cannot send a family permission request to yourself.',
        'family.error_already_pending': 'You already have a pending request to this user.',
        'family.error_already_active': 'You already have an active family permission with this user.',
        ...
        'admin.nav_deposits': 'Deposits',
        'admin.nav_donations': 'Donations',
        'admin.nav_family': 'Family',
        'admin.user_view': 'User View',
        'admin.logout': 'Logout',

        // Admin Family Relationships
        'admin.family_relationships': 'Family Relationships',
        'admin.family_relationships_subtitle': 'Manage family permissions and relationships',
        'admin.family_permissions': 'Family Permissions',
        'admin.requester': 'Requester',
        'admin.target': 'Target User',
        'admin.create_permission': 'Create Permission',
        'admin.select_requester': 'Select requester',
        'admin.select_target': 'Select target',
        'admin.confirm_delete_permission': 'Are you sure you want to remove this family permission?',
        'admin.permission_created': 'Permission created successfully',
        'admin.permission_removed': 'Permission removed successfully',
        'admin.requested_at': 'Requested At',
        'admin.responded_at': 'Responded At',
        'admin.all_permissions': 'All Permissions',
        'admin.no_permissions': 'No permissions found',
        'admin.failed_load_permissions': 'Failed to load permissions',
        'admin.failed_create_permission': 'Failed to create permission',
        'admin.failed_delete_permission': 'Failed to delete permission',
        'admin.select_both_users': 'Please select both requester and target users',
        'admin.cannot_same_user': 'Requester and target cannot be the same user',
        'admin.delete_permission': 'Delete permission',
        'admin.confirm_delete': 'Confirm Delete',
        'admin.status_filter': 'Status Filter',
        'admin.filter_all': 'All Statuses',
        'admin.status_pending': 'Pending',
        'admin.status_accepted': 'Accepted',
        'admin.status_rejected': 'Rejected',
        'admin.status_canceled': 'Canceled',
        'admin.search': 'Search',
        'admin.search_by_name_email': 'Search by name or email...',
        'admin.showing_results': 'Showing {start}-{end} of {total}',
        'admin.previous': 'Previous',
        'admin.next': 'Next',
        'admin.page_of': 'Page {current} of {total}',
        'admin.access_denied': 'Access denied. Super admin role required.',
        'admin.create_permission_info': 'This will create an accepted permission allowing the requester to register and pay for the target user.',
    ...
    lt: {
        ...
        'nav.family': 'Šeima',
        'family.title': 'Šeima',
        'family.info_title': 'Šeimos valdymas',
        'family.info_description': 'Čia galite valdyti šeimos narius ir leidimus. Siųskite prašymus kitiems vartotojams, kad galėtumėte registruoti juos į renginius ir mokėti už juos.',
        'family.invite_email': 'Vartotojo el. paštas',
        'family.can_pay': 'Gali mokėti',
        'family.send_invite': 'Siųsti prašymą',
        'family.sent_requests': 'Išsiųsti prašymai',
        'family.received_requests': 'Gauti prašymai',
        'family.family_members': 'Šeimos nariai',
        'family.no_sent_requests': 'Nėra išsiųstų prašymų',
        'family.no_received_requests': 'Nėra gautų prašymų',
        'family.no_family_members': 'Nėra šeimos narių',
        'family.status_pending': 'Laukia',
        'family.status_accepted': 'Patvirtinta',
        'family.status_rejected': 'Atmesta',
        'family.status_canceled': 'Atšaukta',
        'family.accept': 'Priimti',
        'family.reject': 'Atmesti',
        'family.cancel': 'Atšaukti',
        'family.remove': 'Pašalinti',
        'family.confirm_send': 'Ar tikrai norite siųsti prašymą šiam vartotojui?',
        'family.confirm_remove': 'Ar tikrai norite pašalinti šį šeimos narį?',
        'family.confirm_accept': 'Ar tikrai norite priimti šį prašymą?',
        'family.confirm_reject': 'Ar tikrai norite atmesti šį prašymą?',
        'family.request_sent': 'Prašymas išsiųstas',
        'family.request_accepted': 'Prašymas priimtas',
        'family.request_rejected': 'Prašymas atmestas',
        'family.permission_canceled': 'Leidimas atšauktas',
        ...
        'family.error_user_inactive': 'Atsiprašome, bet negalime išsiųsti prašymo, nes vartotojas nėra aktyvuotas. Kai administratorius aktyvuos vartotoją, tada siųskite prašymą.',
        'family.error_user_not_found': 'Vartotojas su šiuo el. paštu neegzistuoja.',
        'family.error_request_to_self': 'Negalite siųsti šeimos leidimo prašymo sau.',
        'family.error_already_pending': 'Jūs jau turite laukiantį prašymą šiam vartotojui.',
        'family.error_already_active': 'Jūs jau turite aktyvų šeimos leidimą su šiuo vartotoju.',
        ...
        'admin.nav_deposits': 'Depozitai',
        'admin.nav_donations': 'Parama',
        'admin.nav_family': 'Šeima',
        'admin.user_view': 'Vartotojo Vaizdas',
        'admin.logout': 'Atsijungti',

        // Admin Family Relationships
        'admin.family_relationships': 'Šeimos Ryšiai',
        'admin.family_relationships_subtitle': 'Valdyti šeimos leidimus ir ryšius',
        'admin.family_permissions': 'Šeimos Leidimai',
        'admin.requester': 'Prašytojas',
        'admin.target': 'Tikslinis Vartotojas',
        'admin.create_permission': 'Sukurti Leidimą',
        'admin.select_requester': 'Pasirinkti prašytoją',
        'admin.select_target': 'Pasirinkti tikslą',
        'admin.confirm_delete_permission': 'Ar tikrai norite pašalinti šį šeimos leidimą?',
        'admin.permission_created': 'Leidimas sėkmingai sukurtas',
        'admin.permission_removed': 'Leidimas sėkmingai pašalintas',
        'admin.requested_at': 'Prašymo Data',
        'admin.responded_at': 'Atsakymo Data',
        'admin.all_permissions': 'Visi Leidimai',
        'admin.no_permissions': 'Leidimų nerasta',
        'admin.failed_load_permissions': 'Nepavyko užkrauti leidimų',
        'admin.failed_create_permission': 'Nepavyko sukurti leidimo',
        'admin.failed_delete_permission': 'Nepavyko pašalinti leidimo',
        'admin.select_both_users': 'Prašome pasirinkti abu vartotojus',
        'admin.cannot_same_user': 'Prašytojas ir tikslas negali būti tas pats vartotojas',
        'admin.delete_permission': 'Pašalinti leidimą',
        'admin.confirm_delete': 'Patvirtinti Šalinimą',
        'admin.status_filter': 'Statusas',
        'admin.filter_all': 'Visi Statusai',
        'admin.status_pending': 'Laukiama',
        'admin.status_accepted': 'Patvirtinta',
        'admin.status_rejected': 'Atmesta',
        'admin.status_canceled': 'Atšaukta',
        'admin.search': 'Paieška',
        'admin.search_by_name_email': 'Ieškoti pagal vardą arba el. paštą...',
        'admin.showing_results': 'Rodoma {start}-{end} iš {total}',
        'admin.previous': 'Ankstesnis',
        'admin.next': 'Kitas',
        'admin.page_of': 'Puslapis {current} iš {total}',
        'admin.access_denied': 'Prieiga uždrausta. Reikalinga Super Admin rolė.',
        'admin.create_permission_info': 'Tai sukurs patvirtintą leidimą, leidžiantį prašytojui registruoti ir mokėti už tikslinį vartotoją.',
        'common.creating': 'Kuriama...',
        'common.deleting': 'Šalinama...',
